...
public class FlightReader {
    ...
    public static double calcAverageFlightTime(List<FlightInfoDTO> flightList) {
        return flightList.stream()
    ...
    public static List<FlightInfoDTO> getFlightsSortedByArrivalTime(List<FlightInfoDTO> flightList) {
        return flightList.stream()
                .filter(flight -> flight.getDeparture() != null)
